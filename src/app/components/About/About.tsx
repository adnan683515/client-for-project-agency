...
export default function About() {
    return (
        <div className='max-w-[90%] px-2 sm:px-0 mx-auto flex sm:flex-row flex-col  justify-between'>
            ...
            <div className='sm:max-w-[45%]  flex items-center '>
                <div className='space-y-2  w-full'>
                    ...
                    <h1 className='sm:text-5xl font-semibold  sm:max-w-[100%]'>We’re the <span className='text-[var(--color-secondary)]'>Creative</span> Minds Building Tomorrow’s Brands</h1>

                    <p>At InfoBitCode, we craft digital experiences that connect ideas to innovation.
                        ...
                        With creativity and precision, InfoBitCode transforms your vision into digital reality.</p>
            ...
            <div className='flex justify-center max-w-[45%] items-center'>
